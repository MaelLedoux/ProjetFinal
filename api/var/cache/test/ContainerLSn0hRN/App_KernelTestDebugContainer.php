...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Api\\PortfolioController' => 'getPortfolioControllerService',
            'App\\Controller\\Api\\RealisationApiController' => 'getRealisationApiControllerService',
            'App\\Controller\\Api\\ServiceApiController' => 'getServiceApiControllerService',
            'App\\Controller\\RealisationController' => 'getRealisationControllerService',
    ...
    {
        $container->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0GMuzJRk5c', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $container->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NeTg4aFEuo', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o8bmJ2bApU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7QPHYgaQMI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_csrf_token_valid_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OEqWnDggUY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_is_granted_attribute_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EuAGjtmt3x', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bhKxcPgsy1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r+HMxYTH+i', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Of428SIrjW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C3Rh6+I6ya', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\Api\\ContactController', 'App\\Controller\\Api\\PortfolioController', 'App\\Controller\\Api\\RealisationApiController', 'App\\Controller\\Api\\ServiceApiController', 'App\\Controller\\RealisationController', 'App\\Controller\\SecurityController', 'App\\Controller\\ServiceController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        $a = ($container->privates['serializer.data_collector'] ??= new \Symfony\Component\Serializer\DataCollector\SerializerDataCollector());

        return $container->privates['debug.serializer.inner'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.denormalizer.unwrapping'] ?? self::getSerializer_Denormalizer_UnwrappingService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.flatten_exception'] ??= new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.problem'] ?? self::getSerializer_Normalizer_ProblemService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.uid'] ??= new \Symfony\Component\Serializer\Normalizer\UidNormalizer([])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.datetime'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer([])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.constraint_violation_list'] ?? self::getSerializer_Normalizer_ConstraintViolationListService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.mime_message'] ?? self::getSerializer_Normalizer_MimeMessageService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.datetimezone'] ??= new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.dateinterval'] ??= new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer([])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.form_error'] ??= new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.backed_enum'] ??= new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.number'] ??= new \Symfony\Component\Serializer\Normalizer\NumberNormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.data_uri'] ?? self::getSerializer_Normalizer_DataUriService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.translatable'] ?? self::getSerializer_Normalizer_TranslatableService($container)), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.json_serializable'] ??= new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, [])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.denormalizer.array'] ??= new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer()), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(($container->privates['serializer.normalizer.object'] ?? self::getSerializer_Normalizer_ObjectService($container)), $a, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.xml'] ??= new \Symfony\Component\Serializer\Encoder\XmlEncoder([])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.json'] ??= new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, [])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.yaml'] ??= new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL, [])), $a, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(($container->privates['serializer.encoder.csv'] ??= new \Symfony\Component\Serializer\Encoder\CsvEncoder([])), $a, 'default')], []);
    }
    ...
    protected static function getDoctrine_Orm_ContainerRepositoryFactoryService($container)
    {
        return $container->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\PortfolioProjectRepository' => ['privates', 'App\\Repository\\PortfolioProjectRepository', 'getPortfolioProjectRepositoryService', true],
            ...
            'App\\Repository\\PortfolioProjectRepository' => '?',
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.mareva_user'] ?? $container->load('getSecurity_User_Provider_Concrete_MarevaUserService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addGlobal('frontend_url', 'http://localhost:8000');
