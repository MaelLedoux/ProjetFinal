 ...
 */
class getRealisationRepositoryService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RealisationRepository.php';

        return $container->privates['App\\Repository\\RealisationRepository'] = new \App\Repository\RealisationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
