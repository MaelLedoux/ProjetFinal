 ...
 */
class getPortfolioProjectRepositoryService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'App\Repository\PortfolioProjectRepository' shared autowired service.
     *
     * @return \App\Repository\PortfolioProjectRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PortfolioProjectRepository.php';

        return $container->privates['App\\Repository\\PortfolioProjectRepository'] = new \App\Repository\PortfolioProjectRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
