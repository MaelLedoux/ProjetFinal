 ...
 */
class getSecurity_User_Provider_Concrete_MarevaUserService extends App_KernelTestDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.mareva_user' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.mareva_user'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['mareva' => ['password' => '$2y$13$ggsWkHvoM3.pDOjvDtij6ufBqE.GDbagEOYW5kJ.73TDZl69s8dgW', 'roles' => ['ROLE_ADMIN']]]);
    }
}
